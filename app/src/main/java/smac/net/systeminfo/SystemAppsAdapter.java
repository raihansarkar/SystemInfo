...
public class SystemAppsAdapter extends RecyclerView.Adapter<SystemAppsAdapter.ViewHolder> {
    ...
    public SystemAppsAdapter(Context context, List<String> list){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view2 = LayoutInflater.from(context1).inflate(R.layout.installed_apps_child_layout,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        SystemApkInfoExtractor systemApkInfoExtractor = new SystemApkInfoExtractor(context1);

        final String ApplicationPackageName = (String) stringList.get(position);
        String ApplicationLabelName = systemApkInfoExtractor.GetAppName(ApplicationPackageName);
        Drawable drawable = systemApkInfoExtractor.getAppIconByPackageName(ApplicationPackageName);
